...
namespace cat {
  ...
  Symbol Symbol::new_variable(string name, optional<ast::Type> ty, bool is_mutable, Span span) {
  ...
  Symbol Symbol::new_class(string name, vector<std::pair<string, ast::Type>> fields, Span span) {
