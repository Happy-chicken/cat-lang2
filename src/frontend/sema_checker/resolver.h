...
public:
  ...
  void declare_top_level(Symbol symbol, semantics::SemaCtxt &ctx,
                         error::DiagCtxt &diag);
  ...
  void declare_impl_methods(const Impl &imp, Span span,
                            semantics::SemaCtxt &ctx, error::DiagCtxt &diag);

  void declare_global_var(const GlobalVar &gv, Span span,
                          semantics::SemaCtxt &ctx, error::DiagCtxt &diag);
