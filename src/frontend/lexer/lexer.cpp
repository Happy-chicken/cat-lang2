...
static const unordered_map<string, TokenKind> KEYWORDS = {
    ...
    {"struct", TokenKind::Struct}, {"super", TokenKind::Super},
    {"self", TokenKind::Sself},    {"impl", TokenKind::Impl},
    {"trait", TokenKind::Trait},   {"for", TokenKind::For},

    {"fn", TokenKind::Fn},         {"let", TokenKind::Let},
    {"decl", TokenKind::Decl},

    {"if", TokenKind::If},         {"else", TokenKind::Else},
    {"elif", TokenKind::Elif},     {"while", TokenKind::While},
    {"break", TokenKind::Break},   {"continue", TokenKind::Continue},
    {"return", TokenKind::Return},

    {"void", TokenKind::None},     {"ref", TokenKind::Ref},
    {"cref", TokenKind::CRef},     {"own", TokenKind::Own},
    {"ptr", TokenKind::Ptr},
...
Token Lexer::number() {
  ...
  return make_token(is_float ? TokenKind::FloatLiteral : TokenKind::IntLiteral,
